 ...
 * Return: height of `tree` left subtree minus height of right
...
/**
 * binary_tree_is_avl - uses recursive helper to test first if binary 
 ...
 * no repeat values in implementation
